...
Основные параметры камеры и трекинга находятся в `config.json`. Для обычного
запуска длинная строка флагов больше не нужна. Другой конфиг можно указать так:
